...
The gateway is a local **Linux server** that receives the data and stores it in a **MySQL database**. It also hosts a **web dashboard** that displays the data in real time and allows users to check out historical datapoints.
